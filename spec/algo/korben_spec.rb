...
describe "Korben" do
  ...
  describe "constants" do
    ...
    it "should have the character constants defined" do
      @constants.each do |constant|
        RubyPasswordGenrator::Korben.const_defined?(constant.to_sym).must_be :==, true, "The #{constant} constant should be defined."
      end
    end

    it "should be arrays" do
      @constants.each do |constant|
        RubyPasswordGenrator::Korben.const_get(constant.to_sym).is_a?(Array).must_be :==, true, "The #{constant} constant should be an array."
      end
    end
  ...
  describe "generate method" do
    ...
    before do
      @generator = RubyPasswordGenrator::Korben.new

    end

    it "should have a generate method" do
      RubyPasswordGenrator::Korben.public_method_defined?(:generate).must_be :==, true, "The generate method should be defined."
    end

    it "should take one Integer as optional argument" do
      lambda do
        RubyPasswordGenrator::Korben.new("42")
    ...
    it "should not generate passwords that are shorter than 3 characters" do
      lambda do
        RubyPasswordGenrator::Korben.new(2)
    ...
    it "should not generate passwords that are longer than 255 characters" do
      lambda do
        RubyPasswordGenrator::Korben.new(256)
    ...
    it "should generate a password with the required length" do
      generator = RubyPasswordGenrator::Korben.new(10)
